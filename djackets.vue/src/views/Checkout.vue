                     ...
                     <div class="columns is-multiline">
                         <div class="column is-6">
                             ...
                             <div class="field">
                                 <label>Address*</label>
                                 <div class="control">
                                     <input type="email" class="input" v-model="address">
                                 </div>
                             </div>
...
export default {
    ...
    mounted() {
        ...
        if (this.cartTotalLength > 0) {
            this.stripe = Stripe('pk_test_51JguORH1NzQgmddASGumwbfjM9Y95uT7sRS4uP8QZomLFil8E9TWxkWVi2fUZrZ8CN78pVbjH2Pd2xZZPdqQJ7UY00HZj3glfr')
